...
import p04 from './legacy-partials/04-awards-main.html?raw'
...
const AWARDS_MARKUP_EN = [p01, p02, p03, p04, p05, p06].join('\n')

export function AwardsPage() {
  return (
    <LegacyHomePage
      markup={AWARDS_MARKUP_EN}
      documentLang="en"
      pageTitle="DevOps Agency | Awards & Reviews"
    />
  )
}
