...
import p04 from './legacy-partials/04-contacts-main.html?raw'
...
const CONTACTS_MARKUP_EN = [p01, p02, p03, p04, p05, p06].join('\n')

export function ContactsPage() {
  return (
    <LegacyHomePage
      markup={CONTACTS_MARKUP_EN}
      documentLang="en"
      pageTitle="DevOps Agency | Contact us"
    />
  )
}
