...
import p04 from './legacy-partials/04-services-main.html?raw'
...
const SERVICES_MARKUP_EN = [p01, p02, p03, p04, p05, p06].join('\n')

export function ServicesPage() {
  return (
    <LegacyHomePage
      markup={SERVICES_MARKUP_EN}
      documentLang="en"
      pageTitle="DevOps Agency | Services"
    />
  )
}
