...
import p04 from './legacy-partials-fr/04-about-main.html?raw'
...
const ABOUT_MARKUP_FR = [p01, p02, p03, p04, p05, p06].join('\n')

export function FrenchAboutPage() {
  return (
    <LegacyHomePage
      markup={ABOUT_MARKUP_FR}
      documentLang="fr"
      pageTitle="DevOps Agence | À propos"
    />
  )
}
