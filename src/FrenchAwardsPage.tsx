...
import p04 from './legacy-partials-fr/04-awards-main.html?raw'
...
const AWARDS_MARKUP_FR = [p01, p02, p03, p04, p05, p06].join('\n')

export function FrenchAwardsPage() {
  return (
    <LegacyHomePage
      markup={AWARDS_MARKUP_FR}
      documentLang="fr"
      pageTitle="DevOps Agence | Prix & avis"
    />
  )
}
