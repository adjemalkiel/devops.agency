...
import p04 from './legacy-partials-fr/04-privacy-main.html?raw'
...
const PRIVACY_MARKUP_FR = [p01, p02, p03, p04, p05, p06].join('\n')

export function FrenchPrivacyPage() {
  return (
    <LegacyHomePage
      markup={PRIVACY_MARKUP_FR}
      documentLang="fr"
      pageTitle="DevOps Agence | Politique de confidentialité"
    />
  )
}
