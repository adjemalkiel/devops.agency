...
import p04 from './legacy-partials-fr/04-contacts-main.html?raw'
...
const CONTACTS_MARKUP_FR = [p01, p02, p03, p04, p05, p06].join('\n')

export function FrenchContactsPage() {
  return (
    <LegacyHomePage
      markup={CONTACTS_MARKUP_FR}
      documentLang="fr"
      pageTitle="DevOps Agence | Contact"
    />
  )
}
