...
import p04 from './legacy-partials/04-about-main.html?raw'
...
const ABOUT_MARKUP_EN = [p01, p02, p03, p04, p05, p06].join('\n')

export function AboutPage() {
  return (
    <LegacyHomePage
      markup={ABOUT_MARKUP_EN}
      documentLang="en"
      pageTitle="DevOps Agency | About"
    />
  )
}
