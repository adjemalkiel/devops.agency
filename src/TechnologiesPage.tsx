...
import p04 from './legacy-partials/04-technologies-main.html?raw'
...
const TECHNOLOGIES_MARKUP_EN = [p01, p02, p03, p04, p05, p06].join('\n')

export function TechnologiesPage() {
  return (
    <LegacyHomePage
      markup={TECHNOLOGIES_MARKUP_EN}
      documentLang="en"
      pageTitle="DevOps Agency | Technologies"
    />
  )
}
