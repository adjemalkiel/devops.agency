...
import p04 from './legacy-partials-fr/04-home-main.html?raw'
...
const HOME_MARKUP_FR = [p01, p02, p03, p04, p05, p06].join('\n')

export function FrenchHomePage() {
  return <LegacyHomePage markup={HOME_MARKUP_FR} documentLang="fr" />
}
